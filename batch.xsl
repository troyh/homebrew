...
<xsl:variable name="recipe" select="document('https://raw.github.com/troyh/homebrew/master/recipes/Fuller's%20ESB.xml')"/>
<!-- <xsl:param name="logurl"/>
<xsl:variable name="log" select="document($logurl)"/> -->
